...
public:
    ...
    virtual void ComputeResidual() override
    {
        ...
        residual_(0) = std::exp(abc(0)*x_*x_*x_*x_*x_ + abc(1)*x_*x_*x_*x_ + abc(2)) - y_;  // 构建残差
    }
    ...
    virtual void ComputeJacobians() override
    {
        ...
        double exp_y =std::exp(abc(0)*x_*x_*x_*x_*x_ + abc(1)*x_*x_*x_*x_ + abc(2));

        Eigen::Matrix<double, 1, 3> jaco_abc;  // 误差为1维，状态量 3 个，所以是 1x3 的雅克比矩阵
        jaco_abc << exp_y*x_*x_*x_*x_*x_, exp_y*x_*x_*x_*x_, 1 * exp_y;
...
int main()
{
    ...
    // 设定待估计参数 a, b, c初始值
    vertex->SetParameters(Eigen::Vector3d (1.,3.,2.));
    // 将待估计的参数加入最小二乘问题
